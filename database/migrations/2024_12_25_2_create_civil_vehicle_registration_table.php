...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('civil_vehicle_registration', function (Blueprint $table) {
            ...
            $table->string('observation')->comment("observaciones o descripción");

            $table->foreignId('civil_personnel_id')->constrained('civilian_personnel')->comment("conductor actual del vehiculo");
